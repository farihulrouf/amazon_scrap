          ...
          <div class="divide-y divide-gray-200">
            <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
              ...
              <div class="relative">
                <button
                  @click="handleLogin"
                  class="bg-cyan-500 text-white rounded-md px-2 py-1 w-full hover:bg-cyan-600 focus:outline-none focus:ring-2 focus:ring-cyan-500"
                >
                  Submit
                </button>
              </div>
...
<script>
// Mengimpor fungsi login dari api.js
